                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group @error('sales_price') has-error @enderror">
                            ...
                            <input type="text" name="sales_price" value="{{old('sales_price')}}" class="form-control">
                            @error('sales_price')
                            <div class="inline-errors">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group mt-4">
                            <input type="submit" class="btn btn-primary" onclick="formSubmit(this)" value="Add Product">
                        </div>
                    </div>
                </div>
            </form>
