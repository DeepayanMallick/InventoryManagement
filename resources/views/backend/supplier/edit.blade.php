                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group @error('company') has-error @enderror">
                                            ...
                                            <input type="text" name="company" value="{{ $supplier->name }}"
                                                class="form-control">
                                            @error('company')
                                            <div class="inline-errors">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group mt-4">
                                            <input type="submit" class="btn btn-primary" onclick="formSubmit(this)" value="Update Supplier">
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form action="{{ route('suppliers.edit', $supplier->id) }}" method="GET">
                                <div class="row Filter">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <a href="{{ route('suppliers.edit', $supplier->id) }}" class="btn btn-danger ml-4">Reset</a>
                                    </div>
                                </div>
                            </form>
                        </div>
