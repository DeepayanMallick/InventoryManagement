                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group mt-4">
                            <input type="submit" class="btn btn-primary" onclick="formSubmit(this)" value="Add Expense">
                        </div>
                    </div>
                </div>
            </form>
            ...
            <form action="{{ route('expenses.index') }}" method="GET">
                <div class="row Filter">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('expenses.index') }}" class="btn btn-danger ml-4">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="action-column tooltip-suggestion">
                            <a class="btn btn-success btn-circle" href="{{ route('expenses.edit', $expense->id) }}"
                                data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>

                            <form id="DeleteExpenseForm-{{$expense->id}}" method="POST"
                                action="{{ route('expenses.destroy', $expense->id) }}" class="action-form">
                                @csrf
                                {{ method_field('DELETE') }}
