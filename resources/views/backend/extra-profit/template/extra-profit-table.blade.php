<div class="row">
    <div class="col-md-4">
        ...
        <div class="ibox-content">
            ...
            @endif
            <form action="{{route('extra-profit.store')}}" method="POST">
                @csrf               
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group mt-4">
                            <input type="submit" class="btn btn-primary" onclick="formSubmit(this)" value="Add Extra Profit">
                        </div>
                    </div>
                </div>
            </form>
